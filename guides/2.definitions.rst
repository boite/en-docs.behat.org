...
.. note::
    ...
    The steps following an undefined step are not executed and marked as
    **skipped**, because their behavior is unpredictable.
...
.. note::
    ...
    The steps following a pending step are not executed and marked as
    **skipped**, because their behavior is unpredictable.
...
.. note::
    The steps following a failed step are not executed and marked as **skipped**,
